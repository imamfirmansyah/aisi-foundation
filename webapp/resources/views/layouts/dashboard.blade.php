                                ...
                                <div class="right-side">
                                    ...
                                    <div class="header-widget">
                                        ...
                                        <div class="user-menu {{ Auth::user()->validate_status ? 'verified' : '' }}">
                                            <div class="user-name"><span><img src="{{ Auth::user()->foto !== null ? asset( 'storage/avatar/'. Auth::user()->foto ) : asset( 'storage/avatar/avatar-boy.png' ) }}" alt="{{ Auth::user()->nama }}"></span>{{ Auth::user()->nama }}</div>
                                            <ul>
