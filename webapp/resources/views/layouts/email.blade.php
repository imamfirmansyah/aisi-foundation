                                                        ...
                                                        <tbody><tr>
                                                            <td align="center">
                                                                <table class="date" border="0" cellpadding="0" cellspacing="0">
                                                                    <tbody><tr>
                                                                        <td>
                                                                            {{--<img  style="display: block;" src="{{ @$message->embed(public_path('frontend/images/email-img/icon-cal.png')) }}" alt="icon 1" width="13">--}}
                                                                            {{--<img  style="display: block;" src="{{ url('frontend/images/email-img/icon-cal.png') }}" alt="icon 1" width="13">--}}
                                                                        </td>
                                                                        <td>&nbsp;&nbsp;</td>
                                                            ...
                                                            <td align="center">
                                                                <table class="tel" align="center" border="0" cellpadding="0" cellspacing="0">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                {{--<img  style="display: block;" src="{{ @$message->embed(public_path('frontend/images/email-img/icon-tel.png')) }}" alt="icon 2" width="17">--}}
                                                                                {{--<img  style="display: block;" src="{{ url('frontend/images/email-img/icon-tel.png') }}" alt="icon 2" width="17">--}}
                                                                            </td>
                                                                            <td>&nbsp;&nbsp;</td>
                                                                            <td style="color: #fefefe; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                                                                <singleline>
                            ...
                            <tbody>
                                                    ...
                                                    <td>
                                                        <table class="logo" align="center" border="0" cellpadding="0" cellspacing="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center">
                                                                        <a href="{{route('home')}}" style="display: block;">Website</a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                ...
                                                <td>
                                                    <table class="mainContent" align="center" border="0" cellpadding="0" cellspacing="0" width="528">
                                                        <tbody>
                                                            ...
                                                            <tr ><td height="40"></td></tr>
                                                            <tr>
                                                                <td style="color: #484848; font-size: 12px; line-height:20px; font-family: Helvetica, Arial, sans-serif; text-align:justify;">
                                                                    Demikian informasi ini kami sampaikan. Untuk informasi lebih lanjut mengenai hal ini silakan hubungi kami melalui <b>kincat@gmail.com</b><br>
                                                                    <br>
                                                                    Salam Hangat,<br>
                                ...
                                <tr>
                                    <td  style="color: #939393; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" class="prefooter-subheader" align="center">
                                        ...
                                        <span style="color: #7087A3">Adress :</span>asdasdasd<br> &nbsp;&nbsp;&nbsp;   <span style="color: #7087A3">Phone :</span> 1231232   &nbsp;&nbsp;&nbsp;<span style="color: #7087A3">Email :</span> kincat@gmail.com
                            ...
                            <tbody>
                                ...
                                <tr bgcolor="7087A3">
                                    <td  style="color: #fff; font-size: 10px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" align="center">
                                        ...
                                        Copyright © {{date('Y')}} Kincat Site. All Rights Reserved
