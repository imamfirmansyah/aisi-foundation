...
(function(r) {
    ...
    (function(n) {
        ...
        D.prototype.symbols.connector = function(c, b, a, k, d) {
            ...
            d = d && d.anchorY;
            var f, m, h = a / 2;
            w(e) && w(d) && (f = ["M", e, d], m = b - d, 0 > m && (m = -k - m), m < a && (h = e < c + a / 2 ? m : a - m), d > b + k ? f.push("L", c + h, b + k) : d < b ? f.push("L",
                c + h, b) : e < c ? f.push("L", c, b + k / 2) : e > c + a && f.push("L", c + a, b + k / 2));
            return f || []
        };
        y.prototype.getPointsOnGraph = function() {
            if (this.xAxis || this.yAxis) {
                ...
                if (this.getPointSpline && f.getPointAtLength && !q) {
                    ...
                    m = f.getTotalLength();
                    for (d =
                             0; d < m; d += 16) b = f.getPointAtLength(d), k.push({
                        chartX: u + b.x,
                        chartY: h + b.y,
                        plotX: b.x,
                        plotY: b.y
        ...
        y.prototype.checkClearPoint = function(c, b, a, k) {
            var d = Number.MAX_VALUE,
                ...
                u = this.chart,
                p, l, n, r, t, g;
            for (t = 0; t < u.boxesToAvoid.length; t +=
                1)
            ...
            c.series.forEach(function(a) {
                ...
                if (a.xAxis || a.yAxis) {
                    ...
                    if (a.visible && !a.isSeriesBoosting && g) {
                        ...
                        for (q = g.length - 1; 0 < q; --q) w ? (e = g[q].chartX - d.width / 2, f = g[q].chartCenterY - d.height / 2) : (e = g[q].chartX + 3, f = g[q].chartY - d.height - 3, b(e, f, d) && (h = a.checkClearPoint(e, f, d)), h && m.push(h), e = g[q].chartX + 3, f = g[q].chartY + 3, b(e, f, d) && (h = a.checkClearPoint(e, f, d)), h && m.push(h), e = g[q].chartX - d.width - 3, f = g[q].chartY + 3, b(e, f, d) && (h = a.checkClearPoint(e, f, d)), h && m.push(h), e = g[q].chartX - d.width - 3, f = g[q].chartY -
                            d.height - 3), b(e, f, d) && (h = a.checkClearPoint(e, f, d)), h && m.push(h);
                        if (n.connectorAllowed && !m.length && !w)
                            for (e = l + v - d.width; e >= l; e -= 16)
