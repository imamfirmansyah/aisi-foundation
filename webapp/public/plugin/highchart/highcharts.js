...
(function(O, J) {
    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            dSetter: function() {
                var a = this.paths[0],
                    ...
                    w;
                if (1 === u) r = this.toD;
                else if (v === c.length && 1 > u)
                    for (; v--;) w = parseFloat(a[v]), r[v] = isNaN(w) ? c[v] : u * parseFloat(c[v] - w) + w;
                else r = c;
        ...
        a.numberFormat = function(h, c, r, u) {
            ...
            var v = a.defaultOptions.lang,
                ...
                n, g, d = h.toString().split("e"); - 1 === c ? c = Math.min(w, 20) : a.isNumber(c) ? c && d[1] && 0 > d[1] && (n = c + +d[1], 0 <= n ? (d[0] = (+d[0]).toExponential(n).split("e")[0], c = n) : (d[0] = d[0].split(".")[0] || 0, h = 20 > c ? (d[0] * Math.pow(10, d[1])).toFixed(c) : 0, d[1] = 0)) : c = 2;
        ...
        a.fireEvent = function(h, c, r, u) {
            ...
            G.createEvent && (h.dispatchEvent || h.fireEvent) ? (v = G.createEvent("Events"), v.initEvent(c, !0, !0), a.extend(v, r), h.dispatchEvent ? h.dispatchEvent(v) : h.fireEvent(c, v)) : ["protoEvents",
                ...
                if (h[m])
                    for (w = h[m][c] || [], n = w.length, r.target || a.extend(r, {
        ...
        a.Color.prototype = {
            ...
            init: function(h) {
                ...
                if ((this.input = h = this.names[h && h.toLowerCase ? h.toLowerCase() :
                    ...
                    for (u = this.parsers.length; u-- && !r;) v = this.parsers[u], (c = v.regex.exec(h)) && (r = v.parse(c));
                this.rgba = r || []
            },
            get: function(a) {
                var c = this.input,
            ...
            brighten: function(a) {
                ...
                if (this.stops) this.stops.forEach(function(c) {
                    ...
                    for (c = 0; 3 > c; c++) h[c] += E(255 * a), 0 > h[c] && (h[c] = 0), 255 < h[c] && (h[c] = 255);
                return this
            },
    ...
    (function(a) {
        ...
        p(y.prototype, {
            ...
            applyTextOutline: function(e) {
                var C = this.element,
                    q, f, k, l, d; - 1 !== e.indexOf("contrast") && (e = e.replace(/contrast/g, this.renderer.getContrast(C.style.fill)));
                e = e.split(" ");
                f = e[e.length - 1];
            ...
            attr: function(e, q, b,
                           f) {
                var C, k = this.element,
                    l, d = this,
                    p, g, A = this.symbolCustomAttribs;
            ...
            addClass: function(a, e) {
                var C = this.attr("class") || ""; - 1 === C.indexOf(a) && (e || (a = (C + (C ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                return this
            },
            hasClass: function(a) {
                return -1 !==
            ...
            zIndexSetter: function(a, q) {
                ...
                if (l) {
                    ...
                    for (g = q.length - 1; 0 <= g && !C; g--)
                        if (b = q[g], l = b.getAttribute("data-z-index"), p = !n(l), b !== d)
                            if (0 > a && p && !f && !g) k.insertBefore(d, q[g]), C = !0;
                            else if (e(l) <= a || p && (!n(a) || 0 <= a)) k.insertBefore(d, q[g + 1] || null), C = !0;
        ...
        p(G.prototype, {
            ...
            init: function(a, e, q, f, b, k, l) {
                ...
                f = d.element;
                a.appendChild(f);
                c(a, "dir", "ltr"); - 1 === a.innerHTML.indexOf("xmlns") && c(f, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = f;
                this.boxWrapper = d;
                this.alignedObjects = [];
                                ...
                                if (" " !== e) {
                                    ...
                                    if (A) {
                                        ...
                                        if (t) p = f.truncate(a, n, e, void 0, 0, Math.max(0, A - parseInt(L || 12, 10)), function(a, e) {
                                            ...
                                            for (; z.length;) z.length && !I && 0 < B && (n = m.createElementNS(K, "tspan"), c(n, {
                                                dy: h,
                                                x: g
            ...
            symbol: function(a, e, q, b, f, k) {
                var l = this,
                    ...
                    C = K && this.symbols[K],
                    x = n(e) && C && C.call(this.symbols,
                        Math.round(e), Math.round(q), b, f, k),
                    c, t;
            ...
            update: function(a) {
                ...
                (this.variableTimezone = !(c && !a.getTimezoneOffset && !a.timezone)) || this.timezoneOffset ? (this.get = function(a, g) {
                    ...
                    if ("Milliseconds" === a || "Seconds" === a || "Minutes" ===
                        a && 0 === g.getTimezoneOffset() % 60) g["set" + a](d);
                    else m = w.getTimezoneOffset(g), m = g.getTime() - m, g.setTime(m), g["setUTC" + a](d), a = w.getTimezoneOffset(g), m = g.getTime() + a, g.setTime(m)
        ...
        a.Tick.prototype = {
            ...
            handleOverflow: function(a) {
                var c = this.axis,
                    ...
                    p = u(c.labelRight, Math.max(c.isRadial ?
                        0 : c.pos + c.len, m - p[1])),
                    l = this.label,
                    f = this.rotation,
                    x = {
                    ...
                    z = 1,
                    k, A = {};
                if (f || "justify" !== u(g.overflow, "justify")) 0 > f && d - x * t < b ? k = Math.round(d / Math.cos(f * v) - b) : 0 < f && d + x * t > p && (k = Math.round((m - d) / Math.cos(f * v)));
                else if (m = d + (1 - x) * t, d - x * t < b ? F = a.x + F * (1 - x) - b : m > p && (F = p - a.x + F * x, z = -1), F = Math.min(h, F), F < h && "center" === c.labelAlign && (a.x += z * (h - F - x * (h - Math.min(t, F)))), t > F || c.autoRotation && (l.styles || {}).width) k = F;
        ...
        a.extend(B.prototype, {
            ...
            defaultLabelFormatter: function() {
                var e = this.axis,
                    ...
                    g = d && d.length,
                    c, p = e.options.labels.format,
                    e = e.isLog ? Math.abs(q) : e.tickInterval;
                if (p) c = m(p, this, b);
                else if (f) c = q;
                else if (l) c = b.dateFormat(l, q);
                else if (g && 1E3 <= e)
                    for (; g-- && void 0 === c;) b = Math.pow(k, g + 1), e >= b && 0 === 10 * q % b && null !== d[g] && 0 !== q && (c = a.numberFormat(q / b, -1) + d[g]);
            ...
            getMinorTickPositions: function() {
                var a = this,
                    ...
                    g = d - l;
                if (g && g / f < a.len / 3)
                    if (a.isLog) this.paddedTicks.forEach(function(e,
                                                                   q, b) {
                        q && k.push.apply(k, a.getLogTickPositions(f, b[q - 1], b[q], !0))
                    });
                    else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) k = k.concat(a.getTimeTicks(a.normalizeTimeTickInterval(f), l, d, q.startOfWeek));
                    else
                        for (q = l + (b[0] - l) % f; q <= d && q !== k[0]; q += f) k.push(q);
            ...
            nameToX: function(a) {
                ...
                v(k) || (k = !1 === this.options.uniqueNames ? a.series.autoIncrement() : e ? f.indexOf(a.name) : F(f.keys[a.name], -1)); - 1 === k ? e || (d = f.length) : d = k;
            ...
            setTickPositions: function() {
                ...
                !b && (!this.ordinalPositions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200) ? (b = [this.min, this.max], a.error(19, !1, this.chart)) : b = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, e.units), this.min, this.max, e.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max), b.length > this.len && (b = [b[0],
                    b.pop()
                ], b[0] === b[1] && (b.length = 1)), this.tickPositions = b, k && (k = k.apply(this, [this.min, this.max]))) && (this.tickPositions = b = k);
            ...
            trimTicks: function(a, b, f) {
                ...
                if (!this.isLinked) {
                    if (b && -Infinity !== e) this.min = e;
                        ...
                        for (; this.min - q > a[0];) a.shift(); if (f) this.max = k;
                    else
                        for (; this.max +
            ...
            adjustTickAmount: function() {
                ...
                if (this.hasData()) {
                    ...
                    } else d > f && (this.tickInterval *= 2, this.setTickPositions()); if (v(k)) {
            ...
            renderUnsquish: function() {
                var a = this.chart,
                    ...
                    g = l && l.style || {}, c = this.horiz,
                    p = this.getSlotWidth(),
                    A = Math.max(1, Math.round(p - 2 * (l.padding || 5))),
                    t = {}, m = this.labelMetrics(),
                ...
                if (this.autoRotation) h > A && h > m.h ? t.rotation = this.labelRotation : this.labelRotation = 0;
                else if (p && (n = A, !x))
                    for (D = "clip", A = k.length; !c && A--;)
    ...
    (function(a) {
        ...
        y.prototype.getLogTickPositions = function(a, r, u, v) {
            ...
            if (.5 <= a) a = Math.round(a), g = this.getLinearTickPositions(a, r, u);
                ...
                for (var n = Math.floor(r), d, m, p, b, l, c = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; n < u + 1 && !l; n++)
                    for (m = c.length, d = 0; d < m && !l; d++) p = this.log2lin(this.lin2log(n) * c[d]), p > r && (!v || b <= u) && void 0 !== b && g.push(b), b > u && (l = !0), b = p;
            else r = this.lin2log(r), u = this.lin2log(u), a = v ? this.getMinorTickInterval() :
    ...
    (function(a, y) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                if (t) z = n.getPlotLinePath(f, H.strokeWidth());
                else if (x) z = n.getPlotBandPath(l, b, d);
                else return;
                F && z && z.length ? (H.attr({
                    d: z
        ...
        a.extend(y.prototype, {
            getPlotBandPath: function(a, c) {
                ...
                if (d && g)
                    for (a && (l = d.toString() === g.toString(), b = 0), a = 0; a < d.length; a += 6) p && g[a + 1] === d[a + 1] ? (g[a + 1] += b, g[a + 4] += b) : p || g[a + 2] !== d[a + 2] || (g[a + 2] += b, g[a + 5] += b), m.push("M", d[a + 1], d[a + 2], "L", d[a + 4], d[a + 5], g[a + 4], g[a + 5], g[a + 1], g[a + 2], "z"), m.isFlat = l;
                return m
            },
            ...
            getPosition: function(a,
                ...
                var g = this.chart,
                    ...
                    A = !this.followPointer &&
                        r(d.ttBelow, !g.inverted === !! d.negative),
                    D = function(a, e, f, k, d, c) {
                        var g = f < k - p,
                            q = k + p + f < e,
                            t = k - p - f;
                        k += p;
                        ...
                        else if (g) b[a] = Math.min(c - f, 0 > t - l ? t : t - l);
                        else if (q) b[a] = Math.max(d, k + l + f > e ? k : k + l);
                        else return !1
                    }, B = function(a, e, f, k) {
                        var d;
            ...
            renderSplit: function(c, g) {
                ...
                c.slice(0, g.length + 1).forEach(function(a, k) {
                    if (!1 !== a && "" !== a) {
                        ...
                        var c = k.series || d,
                            D = c.tt,
                            B = k.series || {}, e = "highcharts-color-" + r(k.colorIndex, B.colorIndex,
                            "none");
                        D || (D = {
                            padding: f.padding,
                            r: f.borderRadius
            ...
            findNearestKDPoint: function(a, b, d) {
                ...
                a.forEach(function(a) {
                    ...
                    if ((l = g(a, !0)) && !(l = !g(f, !0))) var l = f.distX - a.distX,
                        c = f.dist - a.dist, k = (a.series.group && a.series.group.zIndex) - (f.series.group && f.series.group.zIndex), l = 0 < (0 !== l && b ? l : 0 !== c ? c : 0 !== k ? k : f.series.index > a.series.index ? -1 : 1);
                    l && (f = a)
                });
                return f
            },
        ...
        G(a.Pointer.prototype, {
            ...
            pinch: function(a) {
                var c = this,
                    ...
                    d = c.hasZoom,
                    m = c.selectionMarker,
                    p = {}, b = 1 === n && (c.inClass(a.target, "highcharts-tracker") && u.runTrackerClick || c.runChartClick),
                    l = {};
                1 < n && (c.initiated = !0);
        ...
        a.Legend.prototype = {
            ...
            handleOverflow: function(a) {
                ...
                a > g && !1 !== A.enabled ? (this.clipHeight = h = Math.max(g - 20 - this.titleHeight - m, 0), this.currentPage = w(this.currentPage, 1), this.fullHeight = a, u.forEach(function(a, b) {
                    ...
                    m, 9999, 0), b.contentGroup.clip(k)), v(h), e || (this.nav = e = f.g().attr({
                    zIndex: 1
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function(a, b) {
                ...
                b.legendSymbol = this.chart.renderer.rect(f ?
                    (a.symbolWidth - d) / 2 : 0, a.baseline - d + 1, f ? d : a.symbolWidth, d, w(a.options.symbolRadius, d / 2)).addClass("highcharts-point").attr({
                    zIndex: 3
                }).add(b.legendGroup)
            },
    ...
    (function(a) {
        ...
        m(R.prototype, {
            ...
            redraw: function(e) {
                ...
                if (p)
                    for (e = f.length; e--;) D = f[e], D.options.stacking && (D.isDirty = !0);
            ...
            layOutTitles: function(a) {
                ...
                ["title", "subtitle"].forEach(function(a) {
                    ...
                    var c;
                    e && (this.styledMode ||
                    (c = k.style.fontSize), c = d.fontMetrics(c, e).b, e.css({
        ...
        a.Series = a.seriesType("line", null, {
            ...
            setOptions: function(a) {
                var d = this.chart,
                    c = d.options,
                    k = c.plotOptions,
                    e = (d.userOptions || {}).plotOptions || {}, q = k[this.type],
                    l = d.styledMode;
                this.userOptions = a;
                d = b(q, k.series, a);
                this.tooltipOptions =
            ...
            setData: function(b, c, g, l) {
                ...
                if (!v) {
                    ...
                    if (x && A > x) {
                        ...
                        if (m(D))
                            for (g = 0; g < A; g++) z[g] = this.autoIncrement(), r[g] = b[g];
                        else if (d(D))
                            if (u)
                                for (g = 0; g < A; g++) D = b[g], z[g] = D[0], r[g] = D.slice(1, u + 1);
                            else
                                for (g = 0; g < A; g++) D = b[g], z[g] = D[0], r[g] = D[1];
                        else a.error(12, !1, n)
                    } else
                        for (g = 0; g < A; g++) void 0 !== b[g] && (D = {
                            series: e
                        }, e.pointClass.prototype.applyOptions.apply(D, [b[g]]), e.updateParallelArrays(D,
                            g));
            ...
            generatePoints: function() {
                ...
                this.options.keys = a;
                if (d && (l !== (f = d.length) || p))
                    for (z = 0; z < f; z++) z !== m || p || (z += l), d[z] && (d[z].destroyElements(), d[z].plotX = void 0);
                this.data = d;
                this.points = r
            },
            getExtremes: function(a) {
                ...
                var g = c.min,
                    l = c.max,
                    p, t, n = this.requireSorting ? 1 : 0,
                    x, z;
                a = a || this.stackedYData || this.processedYData || [];
                c = a.length;
                for (z = 0; z < c; z++)
                    if (t = f[z], x = a[z], p = (m(x, !0) || d(x)) && (!b.positiveValuesOnly || x.length || 0 < x), t = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (f[z + n] || t) >= g && (f[z - n] || t) <= l, p && t)
                        if (p = x.length)
                            for (; p--;) "number" === typeof x[p] && (e[k++] = x[p]);
                        else e[k++] = x;
                this.dataMin = h(e);
                this.dataMax = E(e)
            },
            ...
            drawPoints: function() {
                var a = this.points,
                    ...
                    m, h, p, t = this[this.specialGroup] || this.markerGroup;
                d = this.xAxis;
                var n, x = f(l.enabled, !d || d.isRadial ? !0 : null, this.closestPointRangePx >= l.enabledThreshold * l.radius);
                if (!1 !== l.enabled || this._hasPointMarkers)
                    for (d = 0; d < a.length; d++) c = a[d], g = c.graphic, m = c.marker || {}, h = !! c.marker, e = x && void 0 === m.enabled || m.enabled, p = !1 !== c.isInside,
            ...
            markerAttribs: function(a, b) {
                var d = this.options.marker,
                    c = a.marker || {}, e = c.symbol || d.symbol,
    ...
    (function(a) {
        ...
        a.cleanRecursively = function(c, f) {
            var g = {};
            b(c, function(b, k) {
                if (d(c[k], !0) && f[k]) b = a.cleanRecursively(c[k], f[k]), Object.keys(b).length && (g[k] = b);
                else if (d(c[k]) || c[k] !== f[k]) g[k] = c[k]
            });
            return g
        };
        w(h.prototype, {
            ...
            update: function(d, c, f, m) {
                ...
                if (h = d.chart) {
                    ...
                    "alignTicks" in h && (t = !0);
                    b(h, function(a, b) {
                        -1 !== k.propsRequireUpdateSeries.indexOf("chart." + b) && (x = !0); - 1 !== k.propsRequireDirtyBox.indexOf(b) && (k.isDirtyBox = !0)
                    });
                ...
                this.collectionsWithUpdate.forEach(function(a) {
                    ...
                    d[a] && ("series" === a && (b = [], k[a].forEach(function(a, d) {
                        ...
                        if (!e && f)
                            if ("series" === a) k.addSeries(d, !1).touched = !0;
                            else if ("xAxis" === a || "yAxis" === a) k.addAxis(d, "xAxis" === a, !1).touched = !0
        ...
        w(x.prototype, {
            addPoint: function(a, b, d, c) {
                ...
                x = m.x;
                n = t.length;
                if (this.requireSorting && x < t[n - 1])
                    for (p = !0; n && t[n - 1] > x;) n--;
            ...
            update: function(b, d) {
                ...
                var c = this,
                    ...
                    h = t[e].prototype,
                    m, x = ["group", "markerGroup", "dataLabelsGroup"],
        ...
        h("area", "line", {
            ...
            getStackPoints: function(c) {
                var h = [],
                    ...
                    m = w.series,
                    p = m.length,
                    b, l = G(w.options.reversedStacks, !0) ? 1 : -1,
                    f;
                c = c || this.points;
                    ...
                    u.forEach(function(a, c) {
                        ...
                        if (g[a] && !g[a].isNull) h.push(g[a]), [-1, 1].forEach(function(k) {
                            var h = 1 === k ? "rightNull" : "leftNull",
                                ...
                                r = n[u[c + k]];
                            if (r)
                                for (f = d; 0 <= f && f < p;) t = r.points[f], t || (f === d ? g[a][h] = !0 : b[f] && (x = n[a].points[f]) && (m -= x[1] - x[0])), f += l;
            ...
            getGraphPath: function(a) {
                var c = E.prototype.getGraphPath,
                    ...
                    m = [],
                    p = this.index,
                    b, l = w.stacks[this.stackKey],
                    f = h.threshold,
                    x = w.getThreshold(h.threshold),
                    t, h = h.connectNulls || "percent" === v,
                    H = function(c, g, k) {
                        var h = a[c];
                        c = v && l[h.x].points[p];
                        var t = h[k + "Null"] || 0;
            ...
            drawPoints: function() {
                ...
                a.points.forEach(function(f) {
                    ...
                    if (c(f.plotY) && null !== f.y) {
                        l = f.shapeArgs;
                        if (g) g[m](r(l));
                        else f.graphic = g = p[f.shapeType](l).add(f.group || a.group);
                        h.borderRadius &&
                        g.attr({
                            r: h.borderRadius
                        });
        ...
        n("pie", "line", {
            ...
            translate: function(a) {
                ...
                var d = 0,
                    ...
                    b = g.slicedOffset,
                    h = b + (g.borderWidth || 0),
                    f, n, t = c(g.startAngle, g.endAngle),
                    r = this.startAngleRad = t.start,
                    t = (this.endAngleRad = t.end) - r,
                    v = this.points,
                    z, k, A = g.dataLabels.distance,
            ...
            connectorShapes: {
                fixedOffset: function(a, c, g) {
                    ...
                    b.x - c.x, 2 * b.y - c.y, b.x, b.y
                    ] : ["L", b.x, b.y]).concat(["L", c.x, c.y])
                },
    ...
    (function(a) {
        ...
        n.prototype.drawDataLabels = function() {
            ...
            function d(a, b) {
                ...
                if (m(a) && !m(b)) c = a.map(function(a) {
                    ...
                    for (d = Math.max(a.length, b.length); d--;) c[d] = r(a[d], b[d]);
                else c = r(a, b);
                return c
            }
            var f = this,
            ...
            if (m(n) || n.enabled || f._hasPointLabels) A = f.plotGroup("dataLabelsGroup", "data-labels", w && !k ? "hidden" : "visible", n.zIndex || 6), w && (A.attr({
                ...
                z.forEach(function(d, k) {
                    var l = d.enabled && !e.isNull && b(e, d),
                        m, q, t, p, n = e.dataLabels ? e.dataLabels[k] : e.dataLabel,
        ...
        n.prototype.alignDataLabel = function(a, d, c, g, m) {
            ...
            if (q && (p = b.renderer.fontMetrics(b.styledMode ? void 0 : c.style.fontSize,
                    ...
                    align: e
                }), k = (t + 720) % 360, k = 180 < k && 360 > k, "left" === e ? l.y -= k ? n.height : 0 : "center" === e ? (l.x -= n.width / 2, l.y -= n.height / 2) : "right" === e && (l.x -= n.width, l.y -= k ? 0 : n.height), d.placed = !0, d.alignAttr = l) : (d.align(c, null, g), l = d.alignAttr),
        ...
        g.pie && (g.pie.prototype.dataLabelPositioners = {
            ...
            b.visible && (h.enabled || b._hasPointLabels) && (d.forEach(function(a) {
                ...
                var l, n, p = d.length,
                    ...
                    x;
                if (p)
                    for (b.sortByAngle(d, f - .5), 0 < b.maxLabelDistance && (l = Math.max(0, y - q - b.maxLabelDistance), n = Math.min(y + q + b.maxLabelDistance, g.plotHeight), d.forEach(function(a) {
                        ...
                        if (h.justify) C = O.justify(c, q, e);
    ...
    (function(a) {
        ...
        y.prototype.hideOverlappingLabels = function(a) {
            var c = this,
                h = a.length,
                n = c.renderer,
                g, d, m, p, b, l, f = function(a, b, c, d, f, g, h, l) {
        ...
        u(p.prototype, {
            ...
            setState: function(a, b) {
                var c = Math.floor(this.plotX),
                    ...
                    l = h && !1 === h.enabled,
                    e = h && h.states && h.states[a || "normal"] || {}, p = !1 === e.enabled,
                    n = f.stateMarkerGraphic,
                    t = this.marker || {}, w = f.chart,
                    x = f.halo,
        ...
        u(b.prototype, {
            ...
            setState: function(a) {
                ...
                if (b.state !== a && ([b.group, b.markerGroup, b.dataLabelsGroup].forEach(function(c) {
                    ...
                    }), b.state = a, !(b.chart.styledMode || f[a] && !1 === f[a].enabled) && (a && (g = f[a].lineWidth || g + (f[a].lineWidthPlus || 0)), d && !d.dashstyle)))
                    for (g = {
                        "stroke-width": g
            ...
            function r(h, n, g, d) {
                ...
                a.objectEach(h, function(a, b) {
                    if (!d && -1 < ["series",
                        ...
                        for (a = c(a), g[b] = [], m = 0; m < a.length; m++) n[b][m] && (g[b][m] = {}, r(a[m], n[b][m], g[b][m], d + 1));
